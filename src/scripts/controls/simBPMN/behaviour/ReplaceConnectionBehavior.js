...
export default function ReplaceConnectionBehavior(eventBus, modeling, bpmnRules, simBPMNRules, injector) {
    ...
    function fixConnection(connection) {
        ...
        if (is(connection, 'bpmn:Association') && !simBPMNRules.canConnectAssociation(source, target)) {
            remove = true;
        }
    ...
    function replaceReconnectedConnection(event) {
        ...
        allowed = simBPMNRules.canConnect(source, target, context.connection)
