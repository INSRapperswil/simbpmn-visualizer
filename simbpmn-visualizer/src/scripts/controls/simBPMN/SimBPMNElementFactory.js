 ...
 */
export default function SimBPMNElementFactory(bpmnFactory, moddle) {
  ...
  this.create = function (elementType, attrs) {
    ...
    // add type to businessObject if simBPMN
    if (/^simBPMN:/.test(type)) {
...
inherits(SimBPMNElementFactory, BpmnElementFactory);

SimBPMNElementFactory.$inject = [
  'bpmnFactory',
  'moddle'
];
 ...
 */
SimBPMNElementFactory.prototype._getCustomElementSize = function (type) {
  var shapes = {
