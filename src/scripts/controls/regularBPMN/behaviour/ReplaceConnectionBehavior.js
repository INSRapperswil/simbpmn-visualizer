...
export default function ReplaceConnectionBehavior(eventBus, modeling, bpmnRules, regularBPMNRules, injector) {
    ...
    function fixConnection(connection) {
        ...
        if (is(connection, 'bpmn:Association') && !regularBPMNRules.canConnectAssociation(source, target)) {
            remove = true;
        }
    ...
    function replaceReconnectedConnection(event) {
        ...
        allowed = regularBPMNRules.canConnect(source, target, context.connection)
